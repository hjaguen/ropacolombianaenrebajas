                    ...
                    <ul className="nav navbar-nav navbar-right">
                        <Stylo.liNav>
                            ...
                            <Stylo.aLink href=""
                              data-toggle="modal"
                              data-target="#email">
                              <i className="fa fa-envelope fa-2x emailytel"></i>
                            </Stylo.aLink>
                        </Stylo.liNav>
                        <Stylo.liNav>
                            {/*<Stylo.aLink className="emailytel">{conf.telContacto}</Stylo.aLink>*/}
                            <Stylo.aLink href="tel:(+34) 962441478">
                              <i className="fa fa-phone fa-2x emailytel"></i>
                            </Stylo.aLink>
                        </Stylo.liNav>
                        <Stylo.liNav>
                          <Stylo.aLink href="https://facebook.com/latinmoda" target="_blank"> <i className="fa fa-facebook fa-2x emailytel"></i></Stylo.aLink>
                        </Stylo.liNav>
                        <Stylo.liNav>
                          <Stylo.aLink href="https://twitter.com/latinmoda" target="_blank"> <i className="fa fa-twitter fa-2x emailytel"></i></Stylo.aLink>
                        </Stylo.liNav>
                        <Stylo.liNav>
                          <Stylo.aLink href="https://instagram.com/latinmoda_oficial" target="_blank"> <i className="fa fa-instagram fa-2x emailytel"></i></Stylo.aLink>
                        </Stylo.liNav>
                        <Stylo.liNav>
                          <Stylo.aLink href={`https://api.whatsapp.com/send?phone=${conf.whatsappMsg}&text=Hola%2C%20necesito%20información`} target="_blank"> <i className="fa fa-whatsapp fa-2x emailytel"></i></Stylo.aLink>
                        </Stylo.liNav>
